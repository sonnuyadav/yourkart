      	...
      	<?php } ?>
                             ...
                             <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title"><?php echo anchor('admin/brands/create', '<i class="fa fa-plus"></i> '. lang('brand_create'), array('class' => 'btn btn-block btn-primary btn-flat')); ?></h3>
                                </div>
                                <div class="box-body">
                                    <table id="datatables" class="table table-striped table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo lang('brand_image');?></th>
                                                
                                                <th><?php echo lang('brand_status');?></th>
                                                <th><?php echo lang('brand_featured');?></th>
                                                <th><?php echo lang('brand_added_at');?></th>
                                                <th><?php echo lang('brand_updated_at');?></th>
...
?>
                                            <tr>
                                               ...
                                               ?></td>
                                                ...
                                                <td>
                                                	<?php echo anchor("admin/brands/create/".$values->id, '&nbsp;','class="fa fa-pencil"'); ?>
                                            		<?php echo anchor("admin/brands/delete/".$values->id,'&nbsp;','class="fa fa-trash delete"'); ?>
                                                	</td>
