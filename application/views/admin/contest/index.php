                                ...
                                <div class="box-body">
                                    <table id="datatables" class="table table-striped table-hover">
                                        <thead>
                                            <tr>
                                            	<th>#</th>
                                                <th><?php echo lang('contest_name');?></th>
                                                <th><?php echo lang('contest_email');?></th>
                                                <th><?php echo lang('contest_phone');?></th>
                                                <th><?php echo lang('contest_city');?></th>
                                                <th><?php echo lang('contest_status');?></th>
                                                <th><?php echo lang('contest_added_at');?></th>
                                                <th><?php echo lang('contest_action');?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
<?php $i=1;foreach ($contests as $values):
...
?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($values->city, ENT_QUOTES, 'UTF-8'); ?></td>
                            <td>
                              <?php echo $statusHTml ?>
                            </td>
                            <td><?php echo htmlspecialchars(date('d M Y h:i:s',strtotime($values->doe)), ENT_QUOTES, 'UTF-8'); ?></td>
                            <td>
                              <a href="<?php echo base_url('admin/contest/changestatus/'.$values->id.'/'.$values->status)?>" class="btn btn-primary">Change Status</a>
                              <a href="<?php echo base_url('admin/contest/delete/'.$values->id) ?>" class="fa fa-trash delete">&nbsp;</a>
                            </td>
