...
<?php endif; ?>
        ...
        <link rel="stylesheet" href="<?php echo base_url($plugins_dir . '/datatables/jquery.dataTables.min.css'); ?>">
        <link rel="stylesheet" href="<?php echo base_url($plugins_dir . '/fancybox/jquery.fancybox.css'); ?>">
        <link rel="stylesheet" href="<?php echo base_url($plugins_dir . '/switch/bootstrap-switch.css'); ?>">
        <link rel="stylesheet" href="<?php echo base_url($plugins_dir . '/jqueryUI/jquery-ui.css'); ?>">
...
<?php if ($mobile === FALSE): ?>
        ...
        <![endif]-->
<?php endif; ?>
<script src="<?php echo base_url($frameworks_dir . '/jquery.min.js'); ?>"></script>
 <script src="<?php echo base_url($plugins_dir . '/jqueryUI/jquery-ui.min.js'); ?>"></script>
<script type="text/javascript">
var URL           = "<?php echo base_url();?>";
var URL_ASSET     = "<?php echo base_url();?>";
