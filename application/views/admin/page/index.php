      	...
      	<?php } ?>
                             ...
                             <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title"><?php echo anchor('admin/page/create', '<i class="fa fa-plus"></i> '. lang('page_create'), array('class' => 'btn btn-block btn-primary btn-flat')); ?></h3>
                                </div>
                                <div class="box-body">
                                    <table id="datatables" class="table table-striped table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo lang('page_added_at');?></th>
                                                <th><?php echo lang('page_updated_at');?></th>
                                        ...
                                        <tbody>
<?php $i=1;foreach ($pages as $values):
?>
                                            <tr>
                                                <td><?php echo $i++ ?></td>
                                                ...
                                                <td>
                                                	<?php echo anchor("admin/page/create/".$values->id, '&nbsp;','class="fa fa-pencil"'); ?>
                                            		<?php echo anchor("admin/page/delete/".$values->id,'&nbsp;','class="fa fa-trash delete"'); ?>
                                                	</td>
