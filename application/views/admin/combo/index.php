      	...
      	<?php } ?>
                             ...
                             <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title"><?php echo anchor('admin/combo/create', '<i class="fa fa-plus"></i> '. lang('combo_create'), array('class' => 'btn btn-block btn-primary btn-flat')); ?></h3>
                                </div>
                                <div class="box-body">
                                    <table id="datatables" class="table table-striped table-hover">
                                        <thead>
                                            <tr>
                                            	<th>#</th>
                                                <th><?php echo lang('combo_name');?></th>
                                                <th><?php echo lang('combo_price');?></th>
                                                <th><?php echo lang('combo_image');?></th>
                                                
                                                
                                                <th><?php echo lang('combo_status');?></th>
                                                <th><?php echo lang('combo_added_at');?></th>
                                                <th><?php echo lang('combo_updated_at');?></th>
                                        ...
                                        <tbody>
<?php $i=1;foreach ($combo as $values):
?>
                                            <tr>
                                                <td><?php echo $i++ ?></td>
                                                ...
                                                <td>
                                                	<?php echo anchor("admin/combo/create/".$values->id, '&nbsp;','class="fa fa-pencil"'); ?>
                                            		<?php echo anchor("admin/combo/delete/".$values->id,'&nbsp;','class="fa fa-trash delete"'); ?>
                                                	</td>
...
window.onload = function() {
    $('.delete').click(function(){
        return confirm('Are you sure to delete this combo?');
    });
