...
class Paginator
{
     ...
     */
    public function __construct($perPage, $instance=false)
    {
        $this->instance = 'page';
    ...
    {
        $this->page = (int) (!isset($_REQUEST[$this->instance]) ? 1 : $_REQUEST[$this->instance]);
    ...
    {   $limitArr['start'] = $this->getStart();
        $limitArr['end'] = $this->perPage;
        return $limitArr;
    }
